                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ftable">
                                                <tbody>
                                                    ...
                                                    <tr v-for="item in orderlist.message" :key="item.id">
                                                        ...
                                                        <td align="left">
                                                            <router-link :to="'/site/vipCenter/myOrderOne/'+item.id" class="">查看订单</router-link>
                                                            <br v-show="item.status == 1">
                                                            <router-link :to="'/site/payOrder/'+item.id" v-show="item.status == 1" href="#/site/goods/payment/12" class="">|去付款</router-link>
                                                            <br>
